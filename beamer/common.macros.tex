...
\newcommand<>\braceDownwards[3][ultra thick,structure!80,font=\footnotesize]{%
  \tikz[remember picture,overlay] \draw [decoration={brace,raise=3pt,amplitude=0.5em},decorate,#1]
        (pic cs:#2.east) -- node[below=3pt] (#2#3) {} (pic cs:#3.west);
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% https://tex.stackexchange.com/questions/110072/tikz-inside-lstlisting-inside-tikz
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand<>{\braceUpwards}[3][ultra thick,structure!80,font=\footnotesize]{%
  \pgfkeys{/nzmacros/drawBrace/.cd,#1}
  \begin{tikzpicture}[remember picture, overlay]
    \node[draw=black, fit={($(pic cs:#2)+(0,1ex)$) ($(pic cs:#3)+(0,1ex)$)}, inner sep=0pt] (rectg) {};%
...
\newcommand<>\braceRightwards[3][ultra thick,structure!80,font=\footnotesize]{%
  \pgfkeys{/nzmacros/drawBrace/.cd,#1}
  \begin{tikzpicture}[remember picture, overlay]
    \node[draw=black, fit={($(pic cs:#2)+(0,1ex)$) (pic cs:#3)}, inner sep=0pt] (rectg) {};%
...
\newcommand<>\braceRightwardsLabel[4][ultra thick,structure!80,font=\footnotesize]{%
  \pgfkeys{/nzmacros/drawBrace/.cd,#1}
  \braceRightwards[#1]{#2}{#3}
  \begin{tikzpicture}[remember picture, overlay]
      \node[right=\pgfkeysvalueof{/nzmacros/drawBrace/labelDistance} of #2#3, structure, font=\small, text width=\pgfkeysvalueof{/nzmacros/drawBrace/labelWidth}, /nzmacros/drawBrace/comment] (#2#3-comment) {#4};%
...
\newcommand<>{\drawBraceInner}[3]{%
  \draw [decoration={brace,amplitude=\pgfkeysvalueof{/nzmacros/drawBrace/braceAmplitude}}, decorate, very thick, /nzmacros/drawBrace/decoration]%
