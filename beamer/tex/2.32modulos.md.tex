...
\nzincludecode[lastline=20]{../scripts/ventas.py}{ventas.py}

## Repaso: funciones y creación de módulos {.fragile}

\nzincludecode[firstline=22, lastline=42]{../scripts/ventas.py}{ventas.py}

## Repaso: funciones y creación de módulos {.fragile}

\nzincludecode[firstline=44]{../scripts/ventas.py}{ventas.py}
