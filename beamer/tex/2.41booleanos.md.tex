...
\drawTikZComment[pos={below right},len={2em and 3em}]{trmSetbool}{\scriptsize Se puede asignar un resultado lógico}
...
\drawTikZComment[pos={right},len={8em}]{booltypedesign01}{\scriptsize Nuevo tipo de dato en nuestra receta}
