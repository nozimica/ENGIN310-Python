...
\visible{<2->}{%
\drawTikZComment[right=5em of intConComillas]{intConComillas}{\scriptsize Ojo con las comillas}
\drawTikZComment[text width = 40mm, right=8em of intSinComillas]{intSinComillas}{\scriptsize Acá no hay comillas: es número}
\drawTikZComment[text width = 40mm, above right=2em and -0.5em of intNumStr]{intNumStr}{\scriptsize Recuerden: los números deben ser convertidos a string en este caso}
}
...
\visible{<2->}{%
\drawTikZComment[right=6em of intSinComillasraw]{intSinComillasraw}{\scriptsize Acá no hay comillas: es \nzinlinecode{raw_input}}
\drawTikZComment[text width = 40mm, above right=1em and -0.5em of intNumStrraw]{intNumStrraw}{\scriptsize No es número, aunque lo parezca}
}
