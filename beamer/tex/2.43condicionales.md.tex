...
\drawTikZComment[below right=.2em and 7em of pic cs:markNonetypedesign01]{markNonetypedesign01}{\scriptsize Nuevo tipo de dato en nuestra receta: se usa cuando no se retorna nada.}
\vspace{-3ex}
...
\drawTikZComment[right=10em of pic cs:nottestingequal, text width=30mm]{nottestingequal}{\scriptsize No detectamos cuando son iguales...}
\vspace{-3ex}
