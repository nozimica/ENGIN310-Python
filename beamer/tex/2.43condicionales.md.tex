...
\drawTikZComment[pos={below right},len={.2em and 7em}]{markNonetypedesign01}{\scriptsize Nuevo tipo de dato en nuestra receta: se usa cuando no se retorna nada.}
...
\drawTikZComment[pos={right},len={10em}, text width=30mm]{nottestingequal}{\scriptsize No detectamos cuando son iguales...}
