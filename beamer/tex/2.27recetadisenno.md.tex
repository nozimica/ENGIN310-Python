...
\braceDownwardsLabel{nombreB}{nombreA}{4mm}{El nombre de la función}{6em}
\braceDownwardsLabel{entradaB}{entradaA}{6mm}{Las entradas}{6em}
\braceDownwardsLabel{salidaB}{salidaA}{4mm}{La salida}{6em}
...
\begin{lstlisting}[linebackgroundcolor={\btLstHL{2-3}}]
...
\begin{lstlisting}[linebackgroundcolor={\btLstHL{4}}]
# consumoVehiculo: num num -> float
# Calcula el consumo de combustible en litros, para un vehículo
# dado su rendimiento [km/lt] y la distancia recorrida [mi].
def consumoVehiculo(rendKmLt, distMillas):
...
\braceDownwardsLabel{defB}{defA}{4mm}{Define el inicio de la función}{6em}
\braceDownwardsLabel{nombreB}{nombreA}{8mm}{El nombre de la función}{6em}
\braceDownwardsLabel{entradaB}{entradaA}{6mm}{Los parámetros}{6em}
